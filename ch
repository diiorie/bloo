...
(async () => {
    ...
    let p, u, h, m, $, g, y, b, v, _ = l("div", {
        ...
        innerHTML: "Instagram-Diiorie",
        onclick: () => window.open("Instagram.com/diiorie", "_blank").focus()
    }), $ = l("div", {
        id: "controlButtons",
        style: {
            display: "flex",
        ...
        innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Cheats<sup>v2</sup></span>'
    }, l("a", {
        className: "bigButton",
        style: {
            cursor: "pointer",
